...
CV_ERL_FROM_ENUM(ImwriteTiffCompressionFlags);
CV_ERL_TO_ENUM(ImwriteTiffCompressionFlags);

CV_ERL_FROM_ENUM(ImwriteTiffPredictorFlags);
CV_ERL_TO_ENUM(ImwriteTiffPredictorFlags);
